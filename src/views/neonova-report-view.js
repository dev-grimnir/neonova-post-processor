/**
 * Full report view — generates the complete standalone HTML report page.
 */
class NeonovaReportView extends BaseNeonovaView {
    ...
    /**
     * Generates the complete standalone report HTML page.
     * Includes styles, charts, and export scripts.
     */
    generateReportHTML() {
        ...
        return `
            ...
            <body class="bg-zinc-950 text-zinc-200">
                ${this.#generateReportBody(csvContent, longDisconnSection)}
                ${this.#generateReportScripts(csvContent)}
            </body>
            </html>
        `;
    }
    ...
    /**
     * Generates the main report body content.
     */
    #generateReportBody(csvContent, longDisconnSection) {
        return `
            <div class="max-w-6xl mx-auto px-8 py-12">
                ...
                <p class="text-center text-zinc-400 mb-16">     Monitoring period: ${this.metrics.monitoringPeriod || 'N/A'}      (${Number(this.metrics.daysSpanned || 0).toFixed(1)} days)     ${this.ignoredEntriesCount > 0 ? ` • ${this.ignoredEntriesCount.toLocaleString()} consecutive duplicates ignored` : ''} </p>
    ...
    /**
     * Generates the stability scores card section.
     */
    ...
    /**
     * Generates the export buttons section.
     */
