    ...
    render() {
        ...
        this.panel.querySelectorAll('.report-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                // Write the order form HTML (including @requires for all needed classes)
                reportTab.document.write(`
                    ...
                    <head>
                        ...
                        <!-- Load all needed classes for generation -->
                        ...
                        <script src="https://raw.githubusercontent.com/dev-grimnir/neonova-post-processor/dev/src/controllers/neonova-collector.js"></script>
                        <script src="https://raw.githubusercontent.com/dev-grimnir/neonova-post-processor/dev/src/controllers/neonova-analyzer.js"></script>
                        <script src="https://raw.githubusercontent.com/dev-grimnir/neonova-post-processor/dev/src/views/neonova-report-view.js"></script>
                        <script src="https://raw.githubusercontent.com/dev-grimnir/neonova-post-processor/dev/src/controllers/neonova-report-controller.js"></script>
                    </head>
                    <body>
                        <h1>Report Request - ${customer.friendlyName || username} (${username})</h1>
                        ...
                        <script>
                            ...
                            // Real generation using existing controller
                            window.generateReport = async function(startDate) {
                                ...
                                try {
                                    // Use existing NeonovaReportController
                                    const reportController = new NeonovaReportController();
                                    const reportHTML = await reportController.generateReportHTMLForRange(startDate, new Date());  // assume new method
