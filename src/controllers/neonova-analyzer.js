...
computeMetrics() {
    ...
    this.metrics = {
        ...
        rollingLabels: this.rollingLabels || [],  // guard against undefined
        ...
        // Removed redundant allEntriesLength
        dailyDisconnects: this.dailyDisconnects,
        dailyLabels: Object.keys(this.dailyCount).sort(),  // ← Added this
